...
'''
# ground truth counts
Y_train, Y_test = get_gt_count(p+'ground_truth_count.txt', 823, 421)
...
np.save(p+'data/X_train_crop.npy', X_train)
...
gt_density = random_crop_density(p+'data/train_gt_density.mat', dim, dim_resize, rang, resize_const, rand_arr[0:823])
np.save(p+'data/train_density_crop.npy', gt_density)
'''